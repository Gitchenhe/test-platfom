    ...
    <div class="login-main">
        ...
        <div class="login-block">
            <form id="form" class="demoform">
                <input type="text" name="email" placeholder="Account" id="userName" datatype="s5-16"
                       errormsg="请输入账号" value="1392928762">
                <input type="password" name="password" class="lock" id="password" placeholder="Password" value="123456"
