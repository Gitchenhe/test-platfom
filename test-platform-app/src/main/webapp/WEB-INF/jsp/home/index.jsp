...
<link rel="stylesheet" href="${contextPath}/statics/css/admin.css">
<script src="${contextPath}/statics/lib/echarts/echarts.js" charset="utf-8"></script>
...
<script type="text/javascript">
    layui.use(['layer','jquery'], function(){
        ...
        require.config({
            paths: {
                echarts: '${contextPath}/statics/lib/echarts/'
            }
        });
        require(
            [
